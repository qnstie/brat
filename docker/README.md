...
Docker scripts based on https://github.com/cassj/brat-docker

# brat docker

This is a docker container deploying an instance of qnstie's version of [brat].

### Building
Go to docker directory and run:

```bash
docker build -t qnstie/brat:latest .
```
